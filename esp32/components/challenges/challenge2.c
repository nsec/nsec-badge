...
void
challenge_RE102(const char *user_code) {
  if (verify(user_code)) {
    // flag-this_is_a_big_huge_enormous_condition
    const char flag[] = "\x64\x6E\x63\x65\x2F\x76\x6A\x6B\x71\x5D\x6B\x71\x5D\x63\x5D\x60\x6B\x65\x5D\x6A\x77\x65\x67\x5D\x67\x6C\x6D\x70\x6F\x6D\x77\x71\x5D\x61\x6D\x6C\x66\x6B\x76\x6B\x6D\x6C";
    for (int i = 0; i < 42; ++i) {
      printf("%c", flag[i] ^ 0x2);
    }
    printf("\n");
